...
public class PropertyControllerTest {
	...
	public void testGetProperties() throws Exception
	{
		...
		when(service.getProperties(propertyType)).thenReturn(property);
		ResponseEntity<List<PropertyEntity>> responseEntity=propertyController.getProperties(propertyType);
	...
	{
		String PropertyType=null;
		when(service.getProperties(PropertyType)).thenThrow(NullPointerException.class);
		ResponseEntity<List<PropertyEntity>> responseEntity=propertyController.getProperties(PropertyType);
