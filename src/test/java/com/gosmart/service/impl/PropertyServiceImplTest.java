...
public class PropertyServiceImplTest {
	...
	public void testGetProperties() throws Exception
	{
		...
		when(repository.findAllByPropertyType(propertyType)).thenReturn(property);
		List<PropertyEntity> property1=service.getProperties(propertyType);
	...
	public void testGetProperties_Exception() throws Exception
	{
		...
		when(repository.findAllByPropertyType(propertyType)).thenThrow(NullPointerException.class);
		service.getProperties(propertyType);
